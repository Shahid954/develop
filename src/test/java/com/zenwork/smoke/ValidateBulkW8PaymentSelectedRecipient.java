...
public class ValidateBulkW8PaymentSelectedRecipient extends TestBase {
public static String payerBusinessName;
	...
	@BeforeClass
	public void setUp() {
		appLibrary = new AppLibrary("ValidateBulkW8PaymentSelectedRecipient");
	}
	
	@Test(dataProvider="PayerData")
	public void businessTypeAddPayer(String businessName, String address, String city, String state,
		...
		apf.fillAddPayerForm(payerEinNum, payerBusinessName, disregardedEntity, payerAddress, city, state, zipCode,country, payerPhoneNumber);
		apf.addPayerDetails();
		...
		mr.uploadFile();	
		mr.sendBulkW8RequestForSelectedRecipient();
		
	}

//	@Test(dependsOnMethods = "businessTypeAddPayer")
//	public void validateRequestW8SelectedRecipient() throws Exception {
//		appLibrary.getDriverInstance();
//		appLibrary.launchApp();// launching the application in browser
//		HomePage ap = new HomePage(appLibrary);
//		DashboardPage dp = new DashboardPage(appLibrary);
