...
public class ValidateBulkW9PaymentSelectedRecipient extends TestBase {
	...
	@BeforeClass
	public void setUp() {
		appLibrary = new AppLibrary("ValidateBulkW9PaymentSelectedRecipient");
	}
	...
	public void validateRequestW9SelectedRecpient() throws Exception {
		appLibrary.getDriverInstance();
		appLibrary.launchApp();// launching the application in browser
		HomePage ap = new HomePage(appLibrary);
		DashboardPage dp = new DashboardPage(appLibrary);
		...
		mr.uploadFile();
		mr.sendBulkW9RequestForSelectedRecipient();
	}
}
