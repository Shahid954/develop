...
public class ValidateUspsMailingSingleRecipient extends TestBase {
	...
	public void setUp() throws Exception {
		appLibrary = new AppLibrary("ValidateUspsMailingPayment");
	...
	public void createPayerAndRecipient(String businessName, String address, String city, String state, String zipCode,
		...
		mf.uspsMailSingleRecipient();
		mf.verifyUspsMailForSingleRecipient("USPS Requested");
	}
