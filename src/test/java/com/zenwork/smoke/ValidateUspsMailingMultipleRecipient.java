...
public class ValidateUspsMailingMultipleRecipient extends TestBase {
	...
	@Test(dataProvider = "AddPayerData", priority = 1)
	...
	public void addMultipleRecipients(String businessName, String address, String city, String state, String zipCode,
		...
		if (exeIndicator.equalsIgnoreCase("Yes")) {
			...
			mf.multipleUspsMail();
			mf.verifyUspsMailForMultipleRecipient("USPS Requested");
		}
