...
public class ValidateSingleFormStateFiling extends TestBase {
	...
	public void addPayerAndRecipient(String businessName, String address, String city, String state, String zipCode,
		...
		pay.fillAddressDetails(recipientAddress, city, zipCode, state);
		pay.submitPayment();
		sn.selectForms();
		ManageFormPage m = f.selectManageForm();
		m.manageFormPayerDropdown(payerBusinessName);
		m.manageFormTaxYearDropdown("2022");
		StateFilingPaymentPage pp = m.stateFilingFormForSingle("1099-NEC");
		pp.payNowButton();
	}
