...
public class ValidateRequestW8ManageRecipient extends TestBase {
	...
	@BeforeClass
	public void setUp() {
		appLibrary = new AppLibrary("ValidateRequestW8ManageRecipient");
	}
	...
	@Test
	public void validateRequestW8() throws Exception {
		appLibrary.getDriverInstance();
		appLibrary.launchApp();// launching the application in browser
		HomePage ap = new HomePage(appLibrary);
		DashboardPage dp = new DashboardPage(appLibrary);
