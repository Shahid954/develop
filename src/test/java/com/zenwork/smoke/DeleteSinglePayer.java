...
public class DeleteSinglePayer extends TestBase {
	...
	@BeforeClass
	public void setUp() {
		appLibrary = new AppLibrary("ValidateSingleDeletePayer");
	}
	...
	public void businessTypeAddPayer(String businessName, String address, String city, String state, String zipCode,
		...
		apf.alertifyOk();
		mpp.singlePayerDelete(payerBusinessName);
		mpp.deleteAlertifyOk();
