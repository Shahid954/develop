...
public class ValidateIndividualTypeAddRecipient extends TestBase {
	...
	public Object[][] getRecipientData() throws Exception {
		String filePath = "Resources" + File.separator + "IndividualTypeAddRecipient.xls";
		Object object[][] = AppLibrary.readExcel(filePath, 0);
		return object;
	}
	...
	@BeforeClass
	public void setUp() {
		appLibrary = new AppLibrary("ValidateIndividualTypeAddRecipient");
	}
	...
	public void individualTypeAddRecipient(String firstName, String lastName, String address, String city, String state,
		...
		arp.fillIndividualAddRecipientForm(payerSsnNum, firstName, lastName, disregardedEntity, payerAddress, city,
				state, zipCode, country, payerPhoneNumber, email);
