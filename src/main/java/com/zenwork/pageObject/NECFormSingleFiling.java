...
public class NECFormSingleFiling {
	...
	// public String addPayer = "xpath:-://input[@id='btnAddEditPayer']";
...
//        WebElement ele = AppLibrary.findElement(driver, selectChosenPayer);
//        AppLibrary.selectElement(ele, payer);
	...
	public MiscSubmitPayersPage saveAndContinueToMisc() throws Exception {
		AppLibrary.clickElement(driver, saveAndContinue);
		return new MiscSubmitPayersPage(appLibrary);
	}
	...
	public void enterStateTaxWithHeld(String amount) throws Exception {
		...
		AppLibrary.waitTillElementClickable(driver, stateIdTextOkButton);
		AppLibrary.clickByJavascript(driver, stateIdTextOkButton);
	}
	...
	public void addMultipleRecipient(String businessNameData, String addressData, String cityData, String stateData,
		...
		for (int i = 1; i <= Integer.parseInt(noOfRecipient); i++) {
			...
			if (i < Integer.parseInt(noOfRecipient)) {
				AppLibrary.waitTillElementLoaded(driver, saveAndAddNewNecButton);
